...
public class ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        Puerto miPuerto = new Puerto("Puerto Deportivo Real", 50, "Málaga", "+34 952 11 22 33");
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Embarcacion e = new Embarcacion(matricula, nombre, eslora, tipo, propietario, anio, valor);
        ...
        while (opcion != 0) {
            ...
            if (opcion == 1) {
                ...
                System.out.println("Ingresos diarios actuales: " + miPuerto.calcularIngresosDiariosActuales() + "€");
            } else if (opcion == 2) {
